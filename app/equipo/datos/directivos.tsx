...
const datos: DatosEquipo = {
  ...
  competencias: {
    ...
    tarjetas: [
      ...
      },
      {
        ...
        texto:
          "Acuerdos estratégicos con socios, clientes y proveedores clave. Manejo de concesiones, silencios y matices culturales sin ceder la postura de la empresa.",
      },
      {
        icono: "presentacion",
        titulo: "Vocería y representación",
        texto:
          "Conducción de foros, paneles y encuentros con medios internacionales, comunicando la visión y estrategia de la compañía con total autoridad.",
      },
      {
        icono: "grafico",
      ...
      },
      {
        ...
        texto:
          "Lectura, análisis y discusión crítica de contratos, reportes financieros y planes estratégicos directamente en su idioma original.",
      },
    ],
  },
  ...
  tablero: {
    ...
    aprobadas: 93,
    alza: 4,
    curva: [67, 62, 57, 53, 42, 31, 23],
    competencias: [74, 70, 81, 77],
    colaboradores: [
      { nivel: "C1", pct: 94 },
      { nivel: "B2", pct: 86 },
      { nivel: "B2", pct: 80 },
  ...
  dolor: {
    ...
    titulo:
      "Su dirección ya sabe decidir. Le falta hacerlo en el idioma de su corporativo.",
    ...
    tarjetas: [
      {
        ...
        texto:
          "Al perder el ritmo en juntas globales, el líder aporta menos y responde con cautela. La empresa pierde peso e influencia en las mesas donde se toman las decisiones clave.",
      },
      {
        icono: "globo",
        titulo: "La relación con casa matriz se enfría",
        texto:
          "Depender de traductores con sedes en Detroit, Múnich, Milán o São Paulo proyecta una imagen secundaria. Los proyectos y presupuestos se asignan a quien comunica directo.",
      },
      {
        icono: "balanza",
        titulo: "La negociación de alto nivel se delega",
        texto:
          "Por la barrera lingüística, el directivo delega acuerdos con socios o proveedores estratégicos. El criterio de quien más conoce el negocio queda fuera de la sala en el momento decisivo.",
      },
    ],
    cta: "Solicite una Cotización",
  },
  ...
  mercado: {
    ...
    texto:
      "Cada junta global en la que su dirección no interviene al ritmo real es peso que la operación local cede. Estos son los datos que sostienen actuar ahora.",
  ...
  diferenciadores: {
    ...
    titulo:
      "Empresas como Braskem Idesa, Chedraui y +500 más eligen S-Peak para su dirección",
    tarjetas: [
      {
        icono: "diana",
        titulo: "Programa diseñado para el rol directivo",
        texto:
          "Evitamos cursos generales. Entrenamos los escenarios reales de representación ejecutiva: juntas de dirección, comunicación con casa matriz, negociaciones y vocería.",
      },
      {
        icono: "escudo",
  ...
  faq: {
    titulo:
      "Preguntas frecuentes sobre capacitación de idiomas para Directivos",
    ...
    preguntas: [
      {
        pregunta:
          "¿Cuánto cuesta formar a un director o a un grupo de mandos directivos en S-Peak?",
        respuesta:
          "El costo depende de la frecuencia, modalidad y duración. Ofrecemos formatos de coaching ejecutivo individual (1-a-1) o sesiones grupales de hasta 10 participantes. Solicite una cotización adaptada a las necesidades de su equipo.",
        respuestaPlana:
          "El costo depende de la frecuencia, modalidad y duración. Ofrecemos formatos de coaching ejecutivo individual (1-a-1) o sesiones grupales de hasta 10 participantes. Solicite una cotización adaptada a las necesidades de su equipo.",
      },
      {
        pregunta:
          "¿El programa respeta la confidencialidad y la agenda de un directivo?",
        respuesta:
          "Sí. Ofrecemos horarios altamente flexibles, un esquema estrictamente confidencial y reportes de avance con el nivel de detalle que el propio directivo autorice.",
        respuestaPlana:
          "Sí. Ofrecemos horarios altamente flexibles, un esquema estrictamente confidencial y reportes de avance con el nivel de detalle que el propio directivo autorice.",
      },
      {
        pregunta:
          "¿En cuánto tiempo un director estará listo para conducir reuniones en otro idioma?",
        respuesta:
          "Depende del nivel inicial. Avanzar de un nivel intermedio (B1) a uno apto para juntas y negociaciones (B2) toma de 6 a 9 meses. Desde un nivel básico (A2), el plazo requerido es de 12 a 18 meses.",
        respuestaPlana:
          "Depende del nivel inicial. Avanzar de un nivel intermedio (B1) a uno apto para juntas y negociaciones (B2) toma de 6 a 9 meses. Desde un nivel básico (A2), el plazo requerido es de 12 a 18 meses.",
      },
      {
        ...
        respuesta:
          "Evaluamos el desempeño real mediante entregables prácticos aplicados a su rol (juntas simuladas, negociaciones o presentaciones corporativas), no con exámenes de memoria. El área coordinadora recibe los reportes con el detalle previamente autorizado.",
        respuestaPlana:
          "Evaluamos el desempeño real mediante entregables prácticos aplicados a su rol (juntas simuladas, negociaciones o presentaciones corporativas), no con exámenes de memoria. El área coordinadora recibe los reportes con el detalle previamente autorizado.",
      },
      {
        ...
        respuesta:
          "Ambos. Diseñamos programas de coaching ejecutivo individual (1-a-1) o cursos grupales para mandos directivos con un límite de 10 participantes por sesión.",
        respuestaPlana:
          "Ambos. Diseñamos programas de coaching ejecutivo individual (1-a-1) o cursos grupales para mandos directivos con un límite de 10 participantes por sesión.",
      },
      {
        ...
        respuesta:
          "Inglés, francés, alemán, italiano, portugués y español para extranjeros. El inglés se enfoca en comités globales, mientras que los demás idiomas se alinean al origen de su casa matriz o socios estratégicos.",
        respuestaPlana:
          "Inglés, francés, alemán, italiano, portugués y español para extranjeros. El inglés se enfoca en comités globales, mientras que los demás idiomas se alinean al origen de su casa matriz o socios estratégicos.",
      },
      {
        pregunta:
          "¿Pueden formar a directivos distribuidos en varias sedes o países?",
        respuesta:
          "Sí. Coordinamos la capacitación simultánea para líderes en México y filiales internacionales, centralizando la gestión y garantizando un estándar de calidad uniforme.",
        respuestaPlana:
          "Sí. Coordinamos la capacitación simultánea para líderes en México y filiales internacionales, centralizando la gestión y garantizando un estándar de calidad uniforme.",
      },
      {
      ...
      {
        pregunta:
          "¿Cuál es el retorno de inversión (ROI) de formar a la dirección?",
        respuesta:
          "Se vuelve tangible cuando sus directivos reportan sin intermediarios, eliminan traductores y defienden presupuestos con autoridad. Una sola negociación internacional o acuerdo clave bien conducido cubre la inversión anual del programa.",
        respuestaPlana:
          "Se vuelve tangible cuando sus directivos reportan sin intermediarios, eliminan traductores y defienden presupuestos con autoridad. Una sola negociación internacional o acuerdo clave bien conducido cubre la inversión anual del programa.",
      },
      {
        pregunta:
          "¿Cómo garantizan que un directivo con poco tiempo realmente avance?",
        respuesta:
          "Diseñamos el plan en torno a su agenda con monitoreo proactivo. Ante ausencias consecutivas, notificamos a la empresa para reajustar las sesiones y proteger la inversión. El enfoque práctico en su día a día asegura un avance constante.",
        respuestaPlana:
          "Diseñamos el plan en torno a su agenda con monitoreo proactivo. Ante ausencias consecutivas, notificamos a la empresa para reajustar las sesiones y proteger la inversión. El enfoque práctico en su día a día asegura un avance constante.",
      },
    ],
