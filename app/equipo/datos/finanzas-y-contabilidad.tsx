...
const datos: DatosEquipo = {
    ...
    tarjetas: [
      {
        ...
        texto:
          "Presentación de cierres, presupuestos y variaciones a la matriz con la soltura para responder preguntas en tiempo real.",
      },
      {
        icono: "presentacion",
      ...
      },
      {
        ...
        texto:
          "Coordinar con tesorería, control de gestión y el corporativo: explicar un supuesto, sustentar un número y discutir un escenario con el registro adecuado.",
      },
      {
        icono: "correo",
        titulo: "Comunicación escrita financiera",
        texto:
          "Redacción precisa de correos, notas explicativas y memos de cierre, garantizando mensajes claros y sin ambigüedades para la casa matriz.",
      },
      {
        icono: "lectura",
        titulo: "Lectura de directrices globales",
        texto:
          "Lectura fluida de reportes de grupo, lineamientos y comunicaciones del corporativo en su idioma original para agilizar la toma de decisiones locales.",
      },
    ],
  },
  ...
  tablero: {
    ...
    aprobadas: 87,
    alza: 7,
    curva: [79, 70, 66, 56, 50, 40, 28],
    competencias: [69, 76, 82, 64],
    colaboradores: [
      { nivel: "B2", pct: 91 },
      { nivel: "B1", pct: 77 },
      { nivel: "B1", pct: 71 },
  ...
  dolor: {
    ...
    titulo:
      "Su equipo ya domina los números. Le falta explicarlos en el idioma de su corporativo.",
    ...
    tarjetas: [
      {
        ...
        texto:
          "Presentar presupuestos o variaciones sin la precisión requerida provoca interpretaciones erróneas en el corporativo. La filial local termina mal evaluada por fallas de comunicación, no por falta de resultados.",
      },
      {
        icono: "lista",
        titulo: "Auditorías internacionales retrasadas",
        texto:
          "No poder explicar los soportes al ritmo que exige un auditor externo o de grupo genera observaciones y requerimientos adicionales innecesarios, derivados únicamente de la limitación lingüística.",
      },
      {
        icono: "balanza",
        titulo: "Pérdida de peso estratégico en las decisiones",
        texto:
          "En comités globales de presupuesto y proyecciones, un equipo que no debate con fluidez cede el control. Las decisiones corporativas terminan tomándose sin considerar el criterio de la realidad local.",
      },
    ],
    cta: "Solicite una Cotización",
  },
  ...
  mercado: {
    ...
    titulo:
      "Por qué su empresa no puede esperar para formar a su equipo de finanzas",
    texto:
      "Cada cierre que se explica a medias es credibilidad que la operación local cede. Estos son los datos que sostienen actuar ahora.",
  ...
  diferenciadores: {
    ...
    titulo:
      "Empresas como Braskem Idesa, Chedraui y +500 más eligen S-Peak para su equipo de finanzas",
    tarjetas: [
      {
        icono: "diana",
        titulo: "Idioma de negocios especializado, no general",
        texto:
          "Sin cursos de conversación básica; entrenamos la comunicación precisa de reportes, variaciones y juntas con el corporativo. Su equipo ya domina la contabilidad, nosotros aportamos el idioma para explicarla.",
      },
      {
        icono: "reloj",
        titulo: "Flexibilidad adaptada a cierres financieros",
        texto:
          "Programas in-company estructurados para respetar la operación de su equipo, ajustándonos a los picos de alta carga de trabajo durante los cierres mensuales y anuales.",
      },
      {
        icono: "globo",
        titulo: "El idioma de su corporativo, no solo inglés",
        texto:
          "Inglés para flujos financieros globales, además de francés, alemán, italiano, portugués o español según el origen y la consolidación de su grupo corporativo.",
      },
      {
        icono: "sello",
  ...
  faq: {
    titulo:
      "Preguntas frecuentes sobre capacitación de idiomas para Finanzas y Contabilidad",
    ...
    preguntas: [
      {
        ...
        respuesta:
          "No. No enseñamos contabilidad ni normativas técnicas. Su equipo ya posee el criterio contable; nosotros aportamos el idioma de negocios necesario para reportar, presentar y coordinar con el corporativo.",
        respuestaPlana:
          "No. No enseñamos contabilidad ni normativas técnicas. Su equipo ya posee el criterio contable; nosotros aportamos el idioma de negocios necesario para reportar, presentar y coordinar con el corporativo.",
      },
      {
        ...
        respuesta:
          "No. Son profesores especializados en idioma de negocios, nativos o bilingües certificados. Su rol es habilitar lingüísticamente al equipo para comunicar sus cifras con claridad, no asesorar financieramente.",
        respuestaPlana:
          "No. Son profesores especializados en idioma de negocios, nativos o bilingües certificados. Su rol es habilitar lingüísticamente al equipo para comunicar sus cifras con claridad, no asesorar financieramente.",
      },
      {
        ...
        respuesta:
          "Depende de la frecuencia, la modalidad, la duración y el tamaño del grupo (de 1 a 10 personas). A mayor volumen de participantes, menor es la inversión por persona. Solicite una cotización adaptada a su área.",
        respuestaPlana:
          "Depende de la frecuencia, la modalidad, la duración y el tamaño del grupo (de 1 a 10 personas). A mayor volumen de participantes, menor es la inversión por persona. Solicite una cotización adaptada a su área.",
      },
      {
        ...
        respuesta:
          "Sí. Diseñamos el programa respetando la alta carga operativa de sus cierres mensuales y anuales para no interferir con las entregas a la matriz.",
        respuestaPlana:
          "Sí. Diseñamos el programa respetando la alta carga operativa de sus cierres mensuales y anuales para no interferir con las entregas a la matriz.",
      },
      {
        ...
        respuesta:
          "Sí. Entrenamos el vocabulario funcional para presentar cierres, explicar variaciones y participar en juntas de control, enfocándonos en la comunicación del negocio —no en la teoría contable—. El vocabulario específico de su operación lo afinamos en el diagnóstico, con el contexto que su equipo aporta.",
        respuestaPlana:
          "Sí. Entrenamos el vocabulario funcional para presentar cierres, explicar variaciones y participar en juntas de control, enfocándonos en la comunicación del negocio —no en la teoría contable—. El vocabulario específico de su operación lo afinamos en el diagnóstico, con el contexto que su equipo aporta.",
      },
      {
        pregunta:
          "¿En cuánto tiempo mi equipo podrá reportar a corporativo en otro idioma?",
        respuesta:
          "Depende del nivel inicial. Pasar de un nivel básico (A2) a uno apto para reportes y presentaciones (B2) toma de 12 a 18 meses. Si el equipo ya es intermedio (B1), toma de 6 a 9 meses.",
        respuestaPlana:
          "Depende del nivel inicial. Pasar de un nivel básico (A2) a uno apto para reportes y presentaciones (B2) toma de 12 a 18 meses. Si el equipo ya es intermedio (B1), toma de 6 a 9 meses.",
      },
      {
        ...
        respuesta:
          "Evaluamos el desempeño real mediante entregables prácticos (explicación de variaciones, presentaciones de cierre o memos financieros) bajo una rúbrica lingüística. El coordinador recibe reportes mensuales con las evidencias correspondientes.",
        respuestaPlana:
          "Evaluamos el desempeño real mediante entregables prácticos (explicación de variaciones, presentaciones de cierre o memos financieros) bajo una rúbrica lingüística. El coordinador recibe reportes mensuales con las evidencias correspondientes.",
      },
      {
      ...
      },
      {
        ...
        respuesta:
          "Inglés, francés, alemán, italiano, portugués y español para extranjeros. Definimos el idioma idóneo en el diagnóstico según el origen de su corporativo o grupo.",
        respuestaPlana:
          "Inglés, francés, alemán, italiano, portugués y español para extranjeros. Definimos el idioma idóneo en el diagnóstico según el origen de su corporativo o grupo.",
      },
      {
        pregunta:
          "¿Pueden capacitar equipos financieros distribuidos en varias sedes o países?",
        respuesta:
          "Sí. Coordinamos el entrenamiento simultáneo de equipos en México y sedes internacionales de forma centralizada y bajo un mismo estándar de calidad. (Las sesiones en línea se imparten en cualquier sede; la modalidad presencial aplica en México.)",
        respuestaPlana:
          "Sí. Coordinamos el entrenamiento simultáneo de equipos en México y sedes internacionales de forma centralizada y bajo un mismo estándar de calidad. (Las sesiones en línea se imparten en cualquier sede; la modalidad presencial aplica en México.)",
      },
      {
      ...
      {
        pregunta:
          "¿Cuál es el retorno de inversión (ROI) de capacitar al equipo de finanzas?",
        respuesta:
          "Se vuelve tangible al eliminar interpretaciones erróneas en la presentación de cifras corporativas y al agilizar las auditorías internacionales. Asegurar que el criterio de su equipo se transmita sin el filtro del idioma protege la reputación de la filial.",
        respuestaPlana:
          "Se vuelve tangible al eliminar interpretaciones erróneas en la presentación de cifras corporativas y al agilizar las auditorías internacionales. Asegurar que el criterio de su equipo se transmita sin el filtro del idioma protege la reputación de la filial.",
      },
    ],
