...
const SCRIPT_WHATSAPP = `
  (function () {
    ...
    window.submitWaForm = function (e) {
      ...
      const msg = 'Hola, soy ' + nombre + ' (' + telefono + '). Me interesa conocer más sobre los programas de alemán para empresas de S-Peak. Mi correo es ' + correo + '.';
