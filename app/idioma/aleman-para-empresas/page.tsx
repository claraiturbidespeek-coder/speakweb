...
const PASOS: PasoMetodo[] = [
  {
    ...
    descripcion:
      "Evaluamos el nivel real de cada colaborador y las situaciones concretas en que usa el alemán en su puesto. No asumimos, medimos.",
  ...
  },
  {
    ...
    descripcion:
      "Un gerente de calidad que sostiene una auditoría no aprende lo mismo que un ingeniero que trabaja con especificaciones de proceso, ni al mismo ritmo. Cada programa se diseña según el puesto, el nivel actual y los retos reales del día a día.",
  ...
  {
    titulo: "Alemán aplicado, no alemán teórico.",
    descripcion:
      "Cada sesión replica situaciones reales: una auditoría de la matriz, un correo de escalamiento a la planta en Alemania, la presentación de un plan de acción ante el corporativo. Sus colaboradores practican lo que van a usar al día siguiente.",
    etiqueta: "Alemán aplicado, no alemán teórico",
    icono: (
  ...
  },
  {
    ...
    descripcion:
      "Nos adaptamos a la agenda de su equipo, incluidos los turnos de planta y la diferencia de horario con Alemania. Cancelaciones, reposiciones y material compartido después de cada sesión. Sin fricciones, sin excusas.",
  ...
  <div className={styles.heroInner}>
    ...
    <div className={`${styles.heroVisual} reveal`}>
      ...
      <div className={styles.heroPhoto}>
        <img {...imagenResponsiva("/images/ejecutiva-hero.webp", "(max-width: 960px) calc(100vw - 40px), (max-width: 1280px) 34vw, 426px")} alt="Ejecutiva en un curso de alemán para empresas de S-Peak" width="740" height="1080" loading="eager" fetchPriority="high" />
      </div>
  ...
  <div className={styles.areasInner}>
    <div className="reveal">
      <div className={styles.areasMedia}>
        <img {...imagenResponsiva("/images/imagen-ejecutivo.webp", "(max-width: 600px) 560px, (max-width: 960px) calc(100vw - 40px), (max-width: 1200px) 560px, (max-width: 1440px) 48vw, 697px")} alt="Ejecutivo en un programa de alemán para empresas de S-Peak" width="1024" height="768" loading="lazy" />
      </div>
    </div>
...
{/* TESTIMONIOS — son los de la landing de inglés, a propósito.
    ...
    cliente, que sabe que no son de su programa de alemán y los quiere aquí
    mientras consigue testimonios propios de este programa. No los borre.
    Cuando lleguen los de alemán, se sustituyen en este bloque. */}
...
<section className="sp-seccion" id="faq">
  <div className={styles.faqInner}>
    <div className={`${styles.faqLeft} reveal`}>
      ...
      <h2>Preguntas frecuentes sobre cursos de alemán para empresas</h2>
    ...
    <div className="sp-faq-lista reveal">
      ...
      <details className="sp-faq-item" name="faq-aleman">
        ...
        <div className="sp-faq-respuesta">Depende del punto de partida, de la constancia del equipo y de cuánto alemán use ya en su puesto. En el diagnóstico inicial medimos el nivel real de cada colaborador y le damos <strong>una proyección concreta para su caso</strong>. <em>Cotice y le estimamos el plan.</em></div>
      </details>
      <details className="sp-faq-item" name="faq-aleman">
        <summary className="sp-faq-pregunta">
