...
// Misma pareja de guiones que la landing de inglés: el ciclo radial del método,
// el carrusel de testimonios y el modal de WhatsApp. Lo único que cambia entre
// las dos páginas es el idioma que se manda en la atribución del lead y el
...
const SCRIPT_WHATSAPP = `
  (function () {
    ...
    window.submitWaForm = function (e) {
      ...
      const msg = 'Hola, soy ' + nombre + ' (' + telefono + '). Me interesa conocer más sobre los programas de francés para empresas de S-Peak. Mi correo es ' + correo + '.';
...
<section className="sp-seccion" id="enfoque">
  <div className={styles.evidenciaInner}>
    ...
    <div className={`${styles.evidenciaRight} reveal`}>
      ...
      <div className={styles.dash} role="img" aria-label="Panel de progreso del equipo en el programa de francés para empresas de S-Peak">
        ...
        <div className={styles.dashContent}>
          <div className={styles.dashChips}>
            <span className={styles.dashChip}><b>+21%</b> mejora</span>
            <span className={styles.dashChip}><b>9</b> colaboradores activos</span>
            <span className={styles.dashChip}><b>32</b> sesiones</span>
          </div>
          <div className={styles.dashGrid}>
            {/* Métrica destacada */}
            <div className={`${styles.dashWidget} ${styles.dashMetric}`}>
              <div className={styles.wMetric}>88<span>%</span></div>
              <div className={styles.wMetricLabel}>Evidencias aprobadas con rúbrica</div>
              <div className={styles.wMetricSub}>↑ 6 pts vs. trimestre anterior</div>
            </div>
            {/* Gráfica de línea */}
            <div className={`${styles.dashWidget} ${styles.dashChart}`}>
              ...
              <svg viewBox="0 0 300 86" preserveAspectRatio="none" aria-hidden="true">
                <polygon fill="#B51E40" fillOpacity="0.08" points="0,72 50,66 100,55 150,58 200,44 250,34 300,22 300,86 0,86"/>
                <polyline fill="none" stroke="#B51E40" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" pathLength="1" points="0,72 50,66 100,55 150,58 200,44 250,34 300,22"/>
                <circle cx="300" cy="22" r="4" fill="#B51E40"/>
              </svg>
            ...
            <div className={`${styles.dashWidget} ${styles.dashSkills}`}>
              ...
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Comunicación oral</span><span className={styles.wSkillPct}>82%</span></div>
                <div className={styles.wBar}><span style={{ width: "82%" }}></span></div>
              </div>
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Comprensión auditiva</span><span className={styles.wSkillPct}>74%</span></div>
                <div className={styles.wBar}><span style={{ width: "74%" }}></span></div>
              </div>
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Redacción corporativa</span><span className={styles.wSkillPct}>71%</span></div>
                <div className={styles.wBar}><span style={{ width: "71%" }}></span></div>
              </div>
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Negociación</span><span className={styles.wSkillPct}>66%</span></div>
                <div className={styles.wBar}><span style={{ width: "66%" }}></span></div>
              </div>
            </div>
            ...
            <div className={styles.dashWidget}>
              ...
              <div className={styles.wPerson}>
                ...
                <span className={styles.wPersonPct}>90%</span>
              </div>
              <div className={styles.wPerson}>
              ...
              <div className={styles.wPerson}>
                ...
                <span className={styles.wPersonPct}>59%</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="reveal">
      <div className={styles.cycle}>
        <div className={styles.cycleCenter}>
          ...
          <div className={styles.cycleDesc} id="cycle-desc">Evaluamos el nivel real de cada colaborador y las situaciones concretas en que usa el francés en su puesto. No asumimos, medimos.</div>
        </div>
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Diagnóstico antes de proponer nada" style={{ left: "13.9%", top: "61.7%" }} data-num="01" data-title="Diagnóstico antes de proponer nada." data-desc="Evaluamos el nivel real de cada colaborador y las situaciones concretas en que usa el francés en su puesto. No asumimos, medimos.">
        ...
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Programa por rol y por nivel" style={{ left: "50%", top: "88%" }} data-num="02" data-title="Programa por rol y por nivel." data-desc="Un director financiero que reporta a la matriz no aprende lo mismo que un comprador que negocia con un proveedor de Quebec, ni al mismo ritmo. Cada programa se diseña según el puesto, el nivel actual y los retos reales del día a día.">
        ...
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Francés aplicado, no francés teórico" style={{ left: "86.1%", top: "61.7%" }} data-num="03" data-title="Francés aplicado, no francés teórico." data-desc="Cada sesión replica situaciones reales: un comité con la matriz en Francia, un correo de seguimiento a un cliente en Montreal, la defensa de una propuesta en una licitación francófona. Sus colaboradores practican lo que van a usar al día siguiente.">
  ...
  <div className={styles.faqInner}>
    ...
    <div className="sp-faq-lista reveal">
      ...
      <details className="sp-faq-item" name="faq-frances">
        ...
        <div className="sp-faq-respuesta">Depende del punto de partida, de la constancia del equipo y de cuánto francés use ya en su puesto. En el diagnóstico inicial medimos el nivel real de cada colaborador y le damos <strong>una proyección concreta para su caso</strong>, con las fechas en que puede esperar cada salto de dominio. <em>Cotice y le estimamos el plan.</em></div>
      </details>
      <details className="sp-faq-item" name="faq-frances">
        <summary className="sp-faq-pregunta">
