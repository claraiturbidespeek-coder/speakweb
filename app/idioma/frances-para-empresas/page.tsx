  ...
  <div className={styles.areasInner}>
    <div className="reveal">
      <div className={styles.areasMedia}>
        <img {...imagenResponsiva("/images/imagen-ejecutivo.webp", "(max-width: 600px) 560px, (max-width: 960px) calc(100vw - 40px), (max-width: 1200px) 560px, (max-width: 1440px) 48vw, 697px")} alt="Ejecutivo en un programa de francés para empresas de S-Peak" width="1024" height="768" loading="lazy" />
      </div>
    </div>
...
<section className="sp-seccion" id="faq">
  <div className={styles.faqInner}>
    <div className={`${styles.faqLeft} reveal`}>
      ...
      <h2>Preguntas frecuentes sobre cursos de francés para empresas</h2>
