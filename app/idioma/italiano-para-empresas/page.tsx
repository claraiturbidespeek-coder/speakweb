  ...
  <div className={styles.heroInner}>
    ...
    <div className={`${styles.heroVisual} reveal`}>
      ...
      <div className={styles.heroPhoto}>
        <img {...imagenResponsiva("/images/ejecutiva-hero.webp", "(max-width: 960px) calc(100vw - 40px), (max-width: 1280px) 34vw, 426px")} alt="Ejecutiva en un curso de italiano para empresas de S-Peak" width="740" height="1080" loading="eager" fetchPriority="high" />
      </div>
  ...
  <div className={styles.areasInner}>
    <div className="reveal">
      <div className={styles.areasMedia}>
        <img {...imagenResponsiva("/images/imagen-ejecutivo.webp", "(max-width: 600px) 560px, (max-width: 960px) calc(100vw - 40px), (max-width: 1200px) 560px, (max-width: 1440px) 48vw, 697px")} alt="Ejecutivo en un programa de italiano para empresas de S-Peak" width="1024" height="768" loading="lazy" />
      </div>
    </div>
