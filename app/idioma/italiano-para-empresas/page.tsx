...
const SCRIPT_PRINCIPAL = `
  ...
  // Mientras la sección de testimonios de italiano esté pendiente de casos
...
const SCRIPT_WHATSAPP = `
  (function () {
    ...
    window.submitWaForm = function (e) {
      ...
      const msg = 'Hola, soy ' + nombre + ' (' + telefono + '). Me interesa conocer más sobre los programas de italiano para empresas de S-Peak. Mi correo es ' + correo + '.';
...
<section className="sp-seccion" id="enfoque">
  <div className={styles.evidenciaInner}>
    ...
    <div className={`${styles.evidenciaRight} reveal`}>
      ...
      <div className={styles.dash} role="img" aria-label="Panel de progreso del equipo en el programa de italiano para empresas de S-Peak">
        ...
        <div className={styles.dashContent}>
          <div className={styles.dashChips}>
            <span className={styles.dashChip}><b>+24%</b> mejora</span>
            <span className={styles.dashChip}><b>11</b> colaboradores activos</span>
            <span className={styles.dashChip}><b>35</b> sesiones</span>
          </div>
          <div className={styles.dashGrid}>
            {/* Métrica destacada */}
            <div className={`${styles.dashWidget} ${styles.dashMetric}`}>
              <div className={styles.wMetric}>94<span>%</span></div>
              <div className={styles.wMetricLabel}>Evidencias aprobadas con rúbrica</div>
              <div className={styles.wMetricSub}>↑ 7 pts vs. trimestre anterior</div>
            </div>
            {/* Gráfica de línea */}
            <div className={`${styles.dashWidget} ${styles.dashChart}`}>
              ...
              <svg viewBox="0 0 300 86" preserveAspectRatio="none" aria-hidden="true">
                <polygon fill="#B51E40" fillOpacity="0.08" points="0,70 50,63 100,58 150,52 200,41 250,36 300,20 300,86 0,86"/>
                <polyline fill="none" stroke="#B51E40" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" pathLength="1" points="0,70 50,63 100,58 150,52 200,41 250,36 300,20"/>
                <circle cx="300" cy="20" r="4" fill="#B51E40"/>
              </svg>
            ...
            <div className={`${styles.dashWidget} ${styles.dashSkills}`}>
              ...
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Comunicación oral</span><span className={styles.wSkillPct}>84%</span></div>
                <div className={styles.wBar}><span style={{ width: "84%" }}></span></div>
              </div>
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Comprensión auditiva</span><span className={styles.wSkillPct}>75%</span></div>
                <div className={styles.wBar}><span style={{ width: "75%" }}></span></div>
              </div>
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Redacción corporativa</span><span className={styles.wSkillPct}>63%</span></div>
                <div className={styles.wBar}><span style={{ width: "63%" }}></span></div>
              </div>
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Negociación</span><span className={styles.wSkillPct}>80%</span></div>
                <div className={styles.wBar}><span style={{ width: "80%" }}></span></div>
              </div>
            </div>
            ...
            <div className={styles.dashWidget}>
              ...
              <div className={styles.wPerson}>
                ...
                <span className={styles.wPersonPct}>65%</span>
              </div>
              <div className={styles.wPerson}>
                ...
                <span className={styles.wPersonPct}>62%</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="reveal">
      <div className={styles.cycle}>
        <div className={styles.cycleCenter}>
          ...
          <div className={styles.cycleDesc} id="cycle-desc">Evaluamos el nivel real de cada colaborador y las situaciones concretas en que usa el italiano en su puesto. No asumimos, medimos.</div>
        </div>
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Diagnóstico antes de proponer nada" style={{ left: "13.9%", top: "61.7%" }} data-num="01" data-title="Diagnóstico antes de proponer nada." data-desc="Evaluamos el nivel real de cada colaborador y las situaciones concretas en que usa el italiano en su puesto. No asumimos, medimos.">
        ...
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Programa por rol y por nivel" style={{ left: "50%", top: "88%" }} data-num="02" data-title="Programa por rol y por nivel." data-desc="Un jefe de mantenimiento que resuelve una falla con el fabricante no aprende lo mismo que un comprador que negocia refacciones y tiempos de entrega, ni al mismo ritmo. Cada programa se diseña según el puesto, el nivel actual y los retos reales del día a día.">
        ...
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Italiano aplicado, no italiano teórico" style={{ left: "86.1%", top: "61.7%" }} data-num="03" data-title="Italiano aplicado, no italiano teórico." data-desc="Cada sesión replica situaciones reales: una llamada al servicio técnico con la línea parada, la puesta en marcha de un equipo junto al técnico del fabricante, una revisión de pedido con la matriz. Sus colaboradores practican lo que van a usar al día siguiente.">
...
{/* TESTIMONIOS — PENDIENTE DE DATOS REALES
    ...
    nombre, empresa y puesto. No se copian a italiano: son de clientes de los
    programas de inglés y traerlos tal cual los presentaría como testimonios
    de un programa de italiano, que es justo lo que no se debe afirmar.

    Para publicar esta sección hacen falta cuatro testimonios reales de
    clientes del programa de italiano (cita, nombre o inicial, empresa y
  ...
  <div className={styles.faqInner}>
    ...
    <div className="sp-faq-lista reveal">
      ...
      <details className="sp-faq-item" name="faq-italiano">
        ...
        <div className="sp-faq-respuesta">Depende del punto de partida, de la constancia del equipo y de cuánto italiano use ya en su puesto. En el diagnóstico inicial medimos el nivel real de cada colaborador y le damos <strong>una proyección concreta para su caso</strong>, con las fechas en que puede esperar cada salto de dominio. <em>Cotice y le estimamos el plan.</em></div>
      </details>
      <details className="sp-faq-item" name="faq-italiano">
        <summary className="sp-faq-pregunta">
