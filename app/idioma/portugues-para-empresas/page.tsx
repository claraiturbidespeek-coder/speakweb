...
const SCRIPT_PRINCIPAL = `
  ...
  // Mientras la sección de testimonios de portugués esté pendiente de casos
...
<section className="sp-seccion" id="enfoque">
  <div className={styles.evidenciaInner}>
    ...
    <div className={`${styles.evidenciaRight} reveal`}>
      ...
      <div className={styles.dash} role="img" aria-label="Panel de progreso del equipo en el programa de portugués para empresas de S-Peak">
        ...
        <div className={styles.dashContent}>
          <div className={styles.dashChips}>
            <span className={styles.dashChip}><b>+19%</b> mejora</span>
            <span className={styles.dashChip}><b>13</b> colaboradores activos</span>
            <span className={styles.dashChip}><b>30</b> sesiones</span>
          </div>
          <div className={styles.dashGrid}>
            {/* Métrica destacada */}
            <div className={`${styles.dashWidget} ${styles.dashMetric}`}>
              <div className={styles.wMetric}>96<span>%</span></div>
              <div className={styles.wMetricLabel}>Evidencias aprobadas con rúbrica</div>
              <div className={styles.wMetricSub}>↑ 3 pts vs. trimestre anterior</div>
            </div>
            {/* Gráfica de línea */}
            <div className={`${styles.dashWidget} ${styles.dashChart}`}>
              ...
              <svg viewBox="0 0 300 86" preserveAspectRatio="none" aria-hidden="true">
                <polygon fill="#B51E40" fillOpacity="0.08" points="0,66 50,61 100,54 150,49 200,38 250,33 300,24 300,86 0,86"/>
                <polyline fill="none" stroke="#B51E40" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" pathLength="1" points="0,66 50,61 100,54 150,49 200,38 250,33 300,24"/>
                <circle cx="300" cy="24" r="4" fill="#B51E40"/>
              </svg>
            ...
            <div className={`${styles.dashWidget} ${styles.dashSkills}`}>
              ...
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Comunicación oral</span><span className={styles.wSkillPct}>86%</span></div>
                <div className={styles.wBar}><span style={{ width: "86%" }}></span></div>
              </div>
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Comprensión auditiva</span><span className={styles.wSkillPct}>91%</span></div>
                <div className={styles.wBar}><span style={{ width: "91%" }}></span></div>
              </div>
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Redacción corporativa</span><span className={styles.wSkillPct}>60%</span></div>
                <div className={styles.wBar}><span style={{ width: "60%" }}></span></div>
              </div>
              <div className={styles.wSkill}>
                <div className={styles.wSkillTop}><span>Negociación</span><span className={styles.wSkillPct}>83%</span></div>
                <div className={styles.wBar}><span style={{ width: "83%" }}></span></div>
              </div>
            </div>
            ...
            <div className={styles.dashWidget}>
              ...
              <div className={styles.wPerson}>
                ...
                <span className={styles.wPersonLvl}>C1</span>
                <span className={styles.wPersonPct}>95%</span>
              </div>
              <div className={styles.wPerson}>
                ...
                <span className={styles.wPersonPct}>88%</span>
              </div>
              <div className={styles.wPerson}>
                ...
                <span className={styles.wPersonPct}>58%</span>
              </div>
              <div className={styles.wPerson}>
                ...
                <span className={styles.wPersonPct}>56%</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="reveal">
      <div className={styles.cycle}>
        <div className={styles.cycleCenter}>
          ...
          <div className={styles.cycleDesc} id="cycle-desc">Evaluamos el nivel real de cada colaborador y las situaciones concretas en que usa el portugués en su puesto. No asumimos, medimos.</div>
        </div>
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Diagnóstico antes de proponer nada" style={{ left: "13.9%", top: "61.7%" }} data-num="01" data-title="Diagnóstico antes de proponer nada." data-desc="Evaluamos el nivel real de cada colaborador y las situaciones concretas en que usa el portugués en su puesto. No asumimos, medimos.">
        ...
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Programa por rol y por nivel" style={{ left: "50%", top: "88%" }} data-num="02" data-title="Programa por rol y por nivel." data-desc="Un director que sostiene el comité regional no aprende lo mismo que un ejecutivo de comercio exterior que revisa documentación de embarque, ni al mismo ritmo. Cada programa se diseña según el puesto, el nivel actual y los retos reales del día a día.">
        ...
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Portugués aplicado, no portugués teórico" style={{ left: "86.1%", top: "61.7%" }} data-num="03" data-title="Portugués aplicado, no portugués teórico." data-desc="Cada sesión replica situaciones reales: un comité regional en São Paulo, una negociación con el distribuidor, la revisión de un contrato o del reporte que llega de la filial. Sus colaboradores practican lo que van a usar al día siguiente.">
        ...
        <button className={`${styles.cycleNode} cycle-node`} aria-label="Flexibilidad que respeta la operación" style={{ left: "27.7%", top: "19.3%" }} data-num="05" data-title="Flexibilidad que respeta la operación." data-desc="Nos adaptamos a la agenda de su equipo, incluida la diferencia de horario con Brasil. Cancelaciones, reposiciones y material compartido después de cada sesión. Sin fricciones, sin excusas.">
...
{/* TESTIMONIOS — PENDIENTE DE DATOS REALES
    ...
    nombre, empresa y puesto. No se copian a portugués: son de clientes de los
    programas de inglés y traerlos tal cual los presentaría como testimonios
    de un programa de portugués, que es justo lo que no se debe afirmar.

    Para publicar esta sección hacen falta cuatro testimonios reales de
    clientes del programa de portugués (cita, nombre o inicial, empresa y
  ...
  <div className={styles.faqInner}>
    ...
    <div className="sp-faq-lista reveal">
      ...
      <details className="sp-faq-item" name="faq-portugues">
        ...
        <div className="sp-faq-respuesta">Depende del punto de partida, de la constancia del equipo y de cuánto portugués use ya en su puesto. En el diagnóstico inicial medimos el nivel real de cada colaborador y le damos <strong>una proyección concreta para su caso</strong>, con las fechas en que puede esperar cada salto de dominio. <em>Cotice y le estimamos el plan.</em></div>
      </details>
      <details className="sp-faq-item" name="faq-portugues">
        <summary className="sp-faq-pregunta">
